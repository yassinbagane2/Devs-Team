...
const IdeasInterface = () => {
    ...
    const ideasList =
        ideas.length > 0
            ? ideas.map((idea) => <li className="text-md" key={idea}>{idea}</li>)
            : "";
    ...
    return (
            ...
            <div className="flex items-center gap-4 flex-col">
                ...
                <div className="flex items-center gap-2">
                    <input
                        ...
                        type="text"
                    />
                    <button className="rounded-md bg-indigo-600 p-3 text-white font-semibold" onClick={getIdeas}>Generate</button>
                </div>
        ...
        />
            ...
            {
                loading || ideasList.length > 0 && (
                <div className="w-[400px] mx-auto rounded-md bg-gray-50 mt-3 shadow-sm border-2 p-4">
                    {loading}
                    <ul className="flex flex-col gap-3 py-2 px-4 list-disc">{ideasList}</ul>
                </div> )
            }
